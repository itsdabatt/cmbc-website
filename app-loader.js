...
(function(){
  const version='20260831allages1';
  ...
  const start=()=>{
    const js=[['church-app.js','cmbcApp'],['kids-corner.js','cmbcKids'],['connect.js','cmbcConnect'],['gallery-rotation.js','cmbcGalleryRotation'],['site-controller.js','cmbcSiteController'],['ease-of-use.js','cmbcEase']];
