...
(function(){
  const version='20260831septemberJourney2';
  ...
  const css=[['church-app.css','cmbcApp'],['kids-corner.css','cmbcKids'],['connect.css','cmbcConnect'],['site-current.css','cmbcCurrent'],['ease-of-use.css','cmbcEase']];
  ...
  const start=()=>{
    const js=[['church-app.js','cmbcApp'],['kids-corner.js','cmbcKids'],['connect.js','cmbcConnect'],['gallery-rotation.js','cmbcGalleryRotation'],['site-controller.js','cmbcSiteController'],['ease-of-use.js','cmbcEase'],['journey-complete.js','cmbcJourneyComplete']];
