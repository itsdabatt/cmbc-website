...
(function(){
  const version='20260903firefest1';
  ...
  const start=()=>{
    const js=[['church-app.js','cmbcApp'],['kids-corner.js','cmbcKids'],['connect.js','cmbcConnect'],['gallery-rotation.js','cmbcGalleryRotation'],['site-controller.js','cmbcSiteController'],['ease-of-use.js','cmbcEase'],['journey-complete.js','cmbcJourneyComplete'],['firefest-resources.js','cmbcFirefest']];
